...
const Styles = require("./MainPage.less");
...
interface MainPageRouteParams {
    todosView: string;
}

interface MainPageProps extends React.Props<MainPage>, ReactRouter.RouteComponentProps<{}, MainPageRouteParams> {
    todosView: TodosView;
    todos: TodoItem[];
    todosTotal: number;
    todosLeft: number;
...
class MainPage extends React.Component<MainPageProps, MainPageState> {
    ...
    shouldComponentUpdate(nextProps: MainPageProps, nextState: MainPageState, nextContext) {
...
export default ReactRedux.connect(
    // mapStateToProps
    (state: AppStore, ownProps: MainPageProps) => {
